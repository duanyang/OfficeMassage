...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> New Forum
        </div>
...
<div id="MainArea">
    ...
    <s:form action="forumManage_%{id == null ? 'add' : 'edit'}">
        ...
        <div id="InputDetailBar">
            ...
            <a href="javascript:history.go(-1);"><front size="8">Go Back</front></a>
        </div>
    </s:form>
</div>
